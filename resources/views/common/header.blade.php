<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    ...
    <div class="row" id="header">
        <a href ="thamrin.co.id" class="active">
           <div class="col-md- col-md-offset-9" style="margin-left=200px;">
              <img src="{{URL::asset('admin/img/TB-Logo.jpg')}}" alt="profile Pic"  width="200px" style=" margin-left:20px;">
           </div>
        </a>
    </div> 
